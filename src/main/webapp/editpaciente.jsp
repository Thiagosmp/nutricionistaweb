		...
		<div class="container-contact1">
			...
			<form action="controllerPaciente" method="post"
				...
				<div class="wrap-input1 validate-input">
					<input placeholder="Nome" class="input1" type="text" name="nome"
						value="<%=conPaciente.getNome()%>" /> <span
						class="shadow-input1"></span>
				</div>
				<div class="wrap-input1 validate-input">
					<input placeholder="E-mail" class="input1" type="text" name="email"
						value="<%=conPaciente.getEmail()%>" /> <span
						class="shadow-input1"></span>
				</div>
				...
				<div class="wrap-input1 validate-input">
					<input placeholder="Idade" class="input1" type="text" name="idade"
						value="<%=conPaciente.getIdade()%>" /> <span
						class="shadow-input1"></span>
				</div>
				<div class="wrap-input1 validate-input">
					<input placeholder="Telefone" class="input1" type="text" name="tel"
						value="<%=conPaciente.getTel()%>" /> <span
						class="shadow-input1"></span>
				</div>
